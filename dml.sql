...
insert into clases(id_asignatura,horas_clase,fecha_clase) values(1,3,current_date());
insert into clases(id_asignatura,horas_clase,fecha_clase) values(1,2,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(1,1,current_date()-2);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(1,2,current_date()-5);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(1,2,current_date()-4);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(2,2,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(3,3,current_date()-2);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(4,1,current_date()-2);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(1,2,current_date()-3);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(2,3,current_date()-3);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(3,2,current_date()-2);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(4,1,current_date()-2);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(1,3,current_date()-2);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(2,2,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(3,1,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(1,2,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(2,1,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(3,2,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(4,3,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(1,2,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(11,1,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(12,1,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(12,1,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(12,1,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(13,1,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(12,1,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(13,1,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(14,1,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(13,1,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(16,1,current_date()-1);
insert into clases(id_asignatura,horas_clase,fecha_clase) values(2,1,current_date()-1);